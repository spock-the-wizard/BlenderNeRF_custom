...
from . import helper, blender_nerf_ui, sof_ui, ttc_ui, cos_ui, sof_operator, ttc_operator, cos_operator, ces_ui, ces_operator
...
PROPS = [
    ...
    ('ces_nb_frames', bpy.props.IntProperty(name='Frames', description='Number of training frames randomly sampled from the training sphere', default=100, soft_min=1) ),
    ('ces_dataset_name', bpy.props.StringProperty(name='Name', description='Name of the COS dataset : the data will be stored under <save path>/<name>', default='dataset') ),
    ...
    ('show_camera_all', bpy.props.BoolProperty(name='Camera', description='Whether to show the training camera', default=False, update=helper.visualize_camera_all) ),
    ...
    ('elev_resolution', bpy.props.IntProperty(name="Elevation Resolution",default=4,min=2,description="Number of steps for latitude")),
    ('azim_resolution', bpy.props.IntProperty(name="Azimuthal Resolution",default=4,min=2,description="Number of steps for latitude"))
]
...
CLASSES = [
    ...
    ces_ui.CES_UI,
    ces_operator.CameraOnEvenSphere,
]
...
def register():
    ...
    # bpy.app.handlers.frame_change_post.append(helper.ces_camera_update)
...
def unregister():
    ...
    # bpy.app.handlers.frame_change_post.remove(helper.ces_camera_update)
